...
export function importTaskSwal() {
    return Swal.fire({
        title: t('import-task'),
        text: t("paste-the-id-of-the-task-you-wish-to-import"),
        input: 'text',
        showCancelButton: true,
        cancelButtonText: t('cancel'),
        confirmButtonText: t('import'),
...
export function taskNotFoundSwal() {
    return Swal.fire(
        t('not-found'),
        t('unable-to-find-a-task-with-the-provided-access-code'),
        'warning'
    )
}
